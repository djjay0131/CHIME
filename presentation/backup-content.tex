% backup-content.tex — appendix material from main.tex.
% Included by main.tex when \WITHBACKUP is defined (via main-backup.tex).
% Compiles standalone via main-backup.tex which sets the flag and \inputs main.
...
\section{Backup: References}

% Slide — References (Questions slide is in the spoken arc; references stay
% in backup for Q&A citation lookups)
