#
# Extra Experiment: Cache sensitivity analysis
# Tests CHIME, Sherman, SMART at different cache sizes (10MB, 100MB, 1000MB)
# on YCSB C (100% read) with 9 CN, 64 threads per CN
#
...
input_path = './params'
output_path = './results'
exp_name = 'extra_cache_sensitivity'
...
def main(cmd: CMDManager, tp: LogParser):
    plot_data = {
        ...
        'X_data': {method: [] for method in methods},   # cache size
    ...
    for cache_size in cache_sizes:
        for method in methods:
            ...
            print_GOOD(f"[FINISHED] cache={cache_size}MB method={method} tpt={tpt} p99={p99_lat}")
            plot_data['X_data'][method].append(cache_size)
